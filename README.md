## Hi there, I'm Amine Zerradi 👋

## 🚀 Current Status

* 🧪 Lead QA Engineer (Web & Mobile)
* 💻 Full-Stack Developer (background)
* 🔧 Automation & Manual Testing Specialist

---

## 👨‍💻 I'm a QA Lead with a Full-Stack background

* 💻 I combine QA leadership with development knowledge to improve product quality end-to-end
* 🧪 Currently focused on Automation, CI/CD, and scalable testing strategies
* 🌱 Continuously improving in Playwright, system design, and advanced debugging
* 👯 Open to collaboration on QA automation, testing strategies, and real-world projects
* 🥅 Current Goals: build robust automation frameworks & contribute to high-impact systems
* ⚡ Fun fact: I approach QA like debugging reality — everything is a system

---

## 💼 Experience Highlights

* Lead QA at Billo (Web + iOS + Android)
* Own testing strategy and release quality
* Strong collaboration with FE/BE in Agile teams
* Hands-on testing: manual, automation, API
* Experience with real production issues (payments, KYC, integrations)
...
* Fiddler Everywhere (traffic debugging)
